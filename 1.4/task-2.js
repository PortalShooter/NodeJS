...
// console.log('Количество выигранных партий:');
// console.log('Количество проигранных партий:');
// console.log('Процентное соотношение выигранных партий.');
// console.log('Частота выпадения орла:');
// console.log('Частота выпадения решки:');